...
function initTonA_init_args(src: TonA_init_args) {
    return (builder: Builder) => {
        let b_0 = builder;
        b_0.storeInt(src.tona_event_tickets_type, 257);
        b_0.storeAddress(src.tona_owner_address);
    };
}

async function TonA_init(tona_event_tickets_type: bigint, tona_owner_address: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
    let builder = beginCell();
    builder.storeRef(__system);
    builder.storeUint(0, 1);
    initTonA_init_args({ $$type: 'TonA_init_args', tona_event_tickets_type, tona_owner_address })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

const TonA_errors: { [key: number]: { message: string } } = {
...
const TonA_getters: ABIGetter[] = [
    {"name":"get_nft_collection_address","arguments":[{"name":"event_id","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"address","optional":true}},
    {"name":"getEventNftCollectionInit","arguments":[{"name":"event_id","type":{"kind":"simple","type":"int","optional":false,"format":257}}],"returnType":{"kind":"simple","type":"StateInit","optional":false}},
    {"name":"state","arguments":[],"returnType":{"kind":"simple","type":"TonAState","optional":false}},
    {"name":"total_fee_for_create_event","arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
]

export const TonA_getterMapping: { [key: string]: string } = {
    'get_nft_collection_address': 'getGetNftCollectionAddress',
    'getEventNftCollectionInit': 'getGetEventNftCollectionInit',
    'state': 'getState',
    'total_fee_for_create_event': 'getTotalFeeForCreateEvent',
}

const TonA_receivers: ABIReceiver[] = [
...
export class TonA implements Contract {
    
    static async init(tona_event_tickets_type: bigint, tona_owner_address: Address) {
        return await TonA_init(tona_event_tickets_type, tona_owner_address);
    }
    
    static async fromInit(tona_event_tickets_type: bigint, tona_owner_address: Address) {
        const init = await TonA_init(tona_event_tickets_type, tona_owner_address);
        const address = contractAddress(0, init);
        return new TonA(address, init);
    }
    
    static fromAddress(address: Address) {
        return new TonA(address);
    }
    ...
    readonly abi: ContractABI = {
        types:  TonA_types,
        getters: TonA_getters,
        receivers: TonA_receivers,
        errors: TonA_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: CreateEvent | SetRoyaltyNumerator | TransferOwnership | Deploy) {
    ...
    async getGetNftCollectionAddress(provider: ContractProvider, event_id: bigint) {
        let builder = new TupleBuilder();
        builder.writeNumber(event_id);
        let source = (await provider.get('get_nft_collection_address', builder.build())).stack;
        let result = source.readAddressOpt();
        return result;
    }
    
    async getGetEventNftCollectionInit(provider: ContractProvider, event_id: bigint) {
        let builder = new TupleBuilder();
        builder.writeNumber(event_id);
        let source = (await provider.get('getEventNftCollectionInit', builder.build())).stack;
    ...
    async getTotalFeeForCreateEvent(provider: ContractProvider) {
        let builder = new TupleBuilder();
        let source = (await provider.get('total_fee_for_create_event', builder.build())).stack;
